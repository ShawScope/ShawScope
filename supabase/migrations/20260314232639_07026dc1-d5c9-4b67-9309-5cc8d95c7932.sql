...
CREATE OR REPLACE FUNCTION public.admin_override_update_appointment(
...
AS $$
BEGIN
  -- Set the override flag for this transaction
  PERFORM set_config('app.admin_override', 'true', true);
  
  -- Perform the update dynamically from the JSON payload
